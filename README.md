...
Apasionado del entorno tech y del análisis de datos desde San José, Costa Rica 🇨🇷</br></br>
🚀 Proyectos Destacados:
Breakdance Freestyle Music (Mobile App): Diseñé, desarrollé y publiqué una aplicación móvil en la Google Play Store enfocada en la enseñar y compartir ritmos urbanos, historia y terminologías del Breakdance, logrando alcanzar más de 10,000 descargas y manteniendo su optimización constante.
</h3>
...
- 🌱 Actualmente estoy trabajando en mi aplicación móvil (FlutterFlow)
...
- 📫 Cómo contactarme: **marcocolocho@gmail.com** <br/>

✍️ Publicaciones y Comunidad:
Artículos Académicos: Comparto investigaciones, guías y tutoriales técnicos sobre infraestructura web y desarrollo 
en plataformas como Academia.edu y blogs académicos especializados.

Google Local Guides (Nivel 9): Colaborador de alto nivel en la comunidad global de Google, aportando activamente al mapeo, 
análisis de entornos urbanos e infraestructura local.
...
- [Landing page de Breakdance Freestyle Music App ](https://www.breakdanceapp.com/)
  
<!-- BLOG-POST-LIST:END -->

---

Credit: [mcolocho | bboymichael](https://github.com/mcolocho/mcolocho)
